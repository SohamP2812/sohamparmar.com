...
export default function RedirectCard({ title, description, href }) {
  ...
  return (
    <div className="flex">
      <Link href={href}>
        <a className="mt-6 min-h-[200px] w-96 transform rounded-xl bg-gradient-to-r from-[#e5e7eb] to-[#e5e7eb] p-1 text-left transition-all hover:scale-[1.02] hover:from-[#d4b5f6] hover:to-[#6d7bf6]">
